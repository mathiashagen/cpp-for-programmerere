...
public:
  ...
  World() : dispatcher(&collision_configuration),
    ...
    transform.setOrigin(btVector3(1.0, 2.0, 0.0));
  ...
  void ballPosHor(float pos) {
    transform.setOrigin(btVector3(pos, falling_sphere.body.getCenterOfMassPosition().getY(), 0.0));
    falling_sphere.body.setCenterOfMassTransform(transform);
  }

  void ballPosVer(float pos) {
    transform.setOrigin(btVector3(falling_sphere.body.getCenterOfMassPosition().getX(), pos, 0.0));
    falling_sphere.body.setCenterOfMassTransform(transform);
  }
